...
class OnlineMultiplayerGameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resetBtn = findViewById(R.id.returnbutton)      //Reset = Return
    ...
    //Das sollte nicht hier sein sonder in einer Logik Klasse!
    fun checkWinner() : Int {
    ...
    //TODO: Port Reset over to GameHolder's Give Up + make it generic
    private fun reset() {
        player1.clear()
        player2.clear()
        emptyCells.clear()
